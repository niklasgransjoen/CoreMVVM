...
namespace CoreMVVM.IOC.Core.Tests
{
    public class LifetimeScopeResolveIEnumerable : LifetimeScopeTestBase
    {
        ...
        {
            var services = LifetimeScope.ResolveRequiredService<IEnumerable<IServiceA>>().ToArray();
        ...
        {
            var services = LifetimeScope.ResolveRequiredService<IEnumerable<IServiceB>>().ToArray();
